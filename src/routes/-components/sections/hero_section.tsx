                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-8">
                            ...
                            {/* Statistics */}
                            <div className="flex gap-12 pt-8 border-t border-white/10 mt-12">
                                <div className="space-y-1">
                                    <div className="text-4xl font-light text-white">40M+</div>
                                    <div className="text-xs uppercase tracking-widest text-teal-500/70 font-bold">
                                        Lives Impacted
                                    </div>
                                </div>
                                <div className="space-y-1">
                                    <div className="text-4xl font-light text-white">105+</div>
                                    <div className="text-xs uppercase tracking-widest text-teal-500/70 font-bold">
                                        Countries
                                    </div>
                                </div>
                                <div className="space-y-1">
                                    <div className="text-4xl font-light text-white">1B+</div>
                                    <div className="text-xs uppercase tracking-widest text-teal-500/70 font-bold">
                                        Data Points
                                    </div>
                                </div>
