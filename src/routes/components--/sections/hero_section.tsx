          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-300 font-medium">
                Advanced AI, Medical Software & Digital Solutions for Hospitals,
                Diagnostics & Healthcare Enterprises
              </p>

              {/* Description */}
              <p className="text-lg text-gray-400 leading-relaxed">
                We design, build, and deploy cutting-edge healthcare technology
                — from AI-powered diagnostics to hospital management systems —
                enabling better clinical decisions, operational efficiency, and
            ...
            <div className="space-y-8">
              ...
              >
                <h3 className="text-xl font-semibold text-white mb-3">
                  {currentSlide.hoverTitle}
                </h3>
                <p className="text-gray-300 leading-relaxed">
                  {currentSlide.hoverContent}
                </p>
              </div>
