                        ...
                        <div className="max-w-4xl mx-auto text-center space-y-12">
                            ...
                            <div className="pt-8">
                                <button
                                    ...
                                    className="px-10 py-5 bg-orange-500 hover:bg-orange-600 rounded-full font-weight-400 text-lg transition-all shadow-2xl shadow-orange-500/20 active:scale-95 flex items-center gap-3 mx-auto"
                                >
